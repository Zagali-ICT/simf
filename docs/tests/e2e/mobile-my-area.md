...
> owner extra (the Face-ID toggle) and the shell header
...
| E2E-MOB014-011 | _(removed 2026-07-03 — the "Update ID photo" row was a test-only affordance and has been deleted from My Area; the ID document is still captured during sign-up)_ | — | — | removed |
