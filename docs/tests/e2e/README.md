...
| `myVisitors` (`GET /app/exhibitor/my-visitors`) — D-426 exhibitor captured-visitor list; DEF-EXH-004 read-path subject eligibility | [`mobile-my-visitors.md`](mobile-my-visitors.md) | E2E-MOBMYVIS-001..008 |
| `scanVisitor` (`scanByBadge` — exhibitor lead-capture scan) — D-426; DEF-EXH-001/002/003/005 scan authorisation + subject eligibility + capture notice + CP-provisioned booth officer | [`mobile-scan-visitor.md`](mobile-scan-visitor.md) | E2E-MOBSCANVIS-001..010 |
