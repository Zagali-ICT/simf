...
| **Coverage gate** | every ✅ Real page in [`docs/pages/PAGE-INDEX.md`](../../pages/PAGE-INDEX.md) has a per-page catalogue file here with ≥1 P0 scenario — **machine-checked** by `tests/SIMF.ControlPanel.Tests/E2eCatalogueIntegrityTests.cs` (`Every_route_PAGE_INDEX_calls_Real_has_a_catalogue_file_with_a_P0_scenario`), so a Real page that ships with no catalogue fails the build instead of passing unnoticed |
...
| `/admin/meeting-tables` | [`cp-meeting-tables.md`](cp-meeting-tables.md) | E2E-MHT-001..015 |
...
| `/admin/session-summaries` | [`cp-admin-session-summaries.md`](cp-admin-session-summaries.md) | E2E-SUM-001..035 |
...
| `/admin/gates/operator` | [`cp-admin-gates-operator.md`](cp-admin-gates-operator.md) | E2E-GOP-001..017 |
...
| `/admin/email/templates` | [`cp-admin-email-templates.md`](cp-admin-email-templates.md) | E2E-EMT-001..014 |
...
| #114 `staffRegisterVisitor` (`POST /app/staff/visitors/register-onsite` · `…/{id}/id-document` · `…/{id}/avatar`) | [`mobile-staff-register-visitor.md`](mobile-staff-register-visitor.md) | E2E-MOBSTAFFREG-001..009 |
...
| #18 `mySeat` (`GET /app/sessions/{id}/seats` + reserve/**move**/release) | [`mobile-my-seat.md`](mobile-my-seat.md) | E2E-MOB018-001..020 |
...
| `myVisitors` (`GET /app/exhibitor/visitors` · `DELETE …/{id}` · `GET …/{id}/vcard`) — D-426 exhibitor captured-visitor list; DEF-EXH-004 read-path subject eligibility (**D-780**: any ACTIVE subject lists, only a deactivated one drops out); DEF-EXH-006 current-booth-membership gate; **FR-EXH-002** remove + vCard export; **FR-EXH-003** the list is scoped to the BOOTH, not the officer | [`mobile-my-visitors.md`](mobile-my-visitors.md) | E2E-MOBMYVIS-001..012 |
...
- **Total scenarios:** 3234 Coverage-matrix rows, every id distinct. That
