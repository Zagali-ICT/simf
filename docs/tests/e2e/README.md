...
| `/admin/reports*` - the reporting module (hub + attendance, registrations, gate activity; Saudi date range, XLSX export) | [`cp-reports.md`](cp-reports.md) | E2E-RPT-001..020 |
