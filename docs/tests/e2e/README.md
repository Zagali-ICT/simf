...
| `/admin/reports*` - the reporting module: hub + all eight reports (attendance, registrations, gate activity, sessions, ratings, partners, meetings, engagement); Saudi date range, XLSX export | [`cp-reports.md`](cp-reports.md) | E2E-RPT-001..035 |
...
- **Total scenarios:** 3067 Coverage-matrix rows, every id distinct. That
