/* =====================================================================
   ...
   Logos are NULL by design — the app renders the name-initials fallback
   (Figma 922:2824); real logos are uploaded later via the Control Panel
   (StoredFile), the same way speaker photos are.
...
IF NOT EXISTS (SELECT 1 FROM dbo.Sponsors WHERE Name = N'Saudi Arabian Military Industries')
    INSERT INTO dbo.Sponsors (Id, Name, NameArabic, Tier, DisplayOrder, Tagline, TaglineArabic, About, AboutArabic, LogoRelativePath, IsActive, CreatedAt, CreatedBy)
