...
| API | `GET /app/sessions/{id}/seats` (approved-only; one read draws the whole hall) |
...
| Status | ✅ Real — D-301 (built) → 898-2873 full parity (2026-06-19, device-verified) → **clean-code frozen (D-600)** |
