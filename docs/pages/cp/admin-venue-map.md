...
| **Backend endpoints** | `POST /account/api/admin/venue-map/list`, `GET /account/api/admin/venue-map/{id}`, `POST /account/api/admin/venue-map`, `PUT /account/api/admin/venue-map/{id}`, `DELETE /account/api/admin/venue-map/{id}`, `POST /account/api/admin/venue-map/export`, `POST /account/api/admin/venue-map/import` (BFF → API `/api/v1/admin/venue-map/*`; public read: `GET /api/v1/app/venue-map`) |
