...
| **Backend endpoints** | `POST /account/api/admin/speakers/list`, `GET /admin/speakers/{id}`, `POST /admin/speakers`, `PUT /admin/speakers/{id}`, `DELETE /admin/speakers/{id}`, `POST /admin/speakers/export`, `POST /admin/speakers/import` |
