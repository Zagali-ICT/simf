...
| **Backend endpoints** | `POST /account/api/admin/exhibitors/list`, `GET /admin/exhibitors/{id}`, `POST /admin/exhibitors`, `PUT /admin/exhibitors/{id}`, `DELETE /admin/exhibitors/{id}`, `GET /admin/exhibitors/{id}/accounts`, `POST /admin/exhibitors/{id}/accounts`, `POST /admin/exhibitors/export`, `POST /admin/exhibitors/import` |
