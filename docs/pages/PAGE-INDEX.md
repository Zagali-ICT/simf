...
| #11 `registrationStatus` (`GET /app/users/me`) | 🟢 Built · Figma `1701:3789` (D-591) | Visitor (pending) | [App/Page_011](../App/Page_011/README.md) | [e2e/mobile-registration-status.md](../tests/e2e/mobile-registration-status.md) |
...
| `savedSessions` (`GET /app/sessions/favourites` ∩ programme) — #8, D-584 | 🟢 Screen built (D-584, Figma `1701:8928`); the favourited sessions with a "★ N جلسة محفوظة" header + category chips, reached from the My-Area "جلسات محفوظة" counter | Visitor / Exhibitor (approved) | [mobile/saved-sessions.md](mobile/saved-sessions.md) | [e2e/mobile-saved-sessions.md](../tests/e2e/mobile-saved-sessions.md) |
...
| #202 `sessionPresentations` (`GET /app/presentations` + `/{id}/file`) | 🟢 Screen built from ComingSoon (D-464 stub → Figma `1388:7621`, title "عروض الجلسات" — the downloadable slides); day-tabbed deck list over the D-228 `SpeakerPresentation` files; new public read + download endpoints (no schema); تحميل → OS share/save; reached from the Home "الجلسات" about-tile (D-583; the More "عروض الجلسات" row moved to my-sessions in D-588) | Approved | _(Figma 1388:7621)_ | [e2e/mobile-session-presentations.md](../tests/e2e/mobile-session-presentations.md) |
| #113 `myAreaSessions` (`GET /app/account/sessions`) | 🟢 Wave 2 my-sessions — **titled "عروض الجلسات"** (Figma `1388:9067`; retitled from "تفاصيل الجلسات" in D-588); القادمة/حضرتها/فاتتني/الأرشيف tabs over the visitor's booked sessions + per-user attended/favourite flags (no schema); reached from the More-menu "عروض الجلسات" row (D-588) | Approved | _(Figma 1388:9067)_ | [e2e/mobile-my-sessions.md](../tests/e2e/mobile-my-sessions.md) |
