...
| #41 `more` (no API) | ✅ Real — Figma `1129:17224`; **clean-code frozen (D-635)**. منطقتي profile card + 3 grouped nav sections (role-filtered) + sign-out + version | Guest+ | [mobile/more/](mobile/more/README.md) | [e2e/mobile-more.md](../tests/e2e/mobile-more.md) |
