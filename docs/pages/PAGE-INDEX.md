...
| `savedSessions` (`GET /app/sessions/favourites` ∩ programme) — #8, D-584 | ✅ Real — built to Figma `1701:8928` (node since removed from the file, D-599); **clean-code frozen (D-599)**, render-lock golden | Visitor / Exhibitor (approved) | [mobile/saved-sessions/](mobile/saved-sessions/README.md) | [e2e/mobile-saved-sessions.md](../tests/e2e/mobile-saved-sessions.md) |
