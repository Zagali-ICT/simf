...
| #35 `meetPeople` (`GET /app/account/recommendations/meet-like-you`) | ✅ Real — Figma `1072:13409`; **clean-code frozen (D-632)**. Smart-suggestions header + per-match cards (% score / reason / avatar); backend match reason (D-451) | Visitor (login-only) | [mobile/meet-people/](mobile/meet-people/README.md) | [e2e/mobile-meet-people.md](../tests/e2e/mobile-meet-people.md) |
