...
| `savedSessions` (`GET /app/sessions/favourites` ∩ programme) — #8, D-584 | 🗑️ **Removed from app — D-609 (2026-07-04)**, owner directive: screen backed up as `.bk`, entry tile deleted from My Area, route → ComingSoon _(was: ✅ built to Figma `1701:8928`, clean-code frozen D-599)_ | Visitor / Exhibitor (approved) | [mobile/saved-sessions/](mobile/saved-sessions/README.md) | [e2e/mobile-saved-sessions.md](../tests/e2e/mobile-saved-sessions.md) |
...
| #115 `myMeetings` (`GET /app/my-requests`, filtered to meetings) — **المقابلات** (D-587, Figma `1701:9406`); the caller's speaker + delegation meetings as person cards with الكل/مكتملة/قيد الانتظار/مرفوضة chips; reached from the My-Area "مقابلات" counter. A read-only view over the الطلبات feed (no new endpoint) | 🗑️ **Removed from app — D-609 (2026-07-04)**, owner directive: screen backed up as `.bk`, entry tile deleted from My Area, route → ComingSoon _(was: 🟢 built D-587)_ | Visitor / Exhibitor (approved) | [mobile/my-meetings.md](mobile/my-meetings.md) | [e2e/mobile-my-meetings.md](../tests/e2e/mobile-my-meetings.md) |
...
| #113 `myAreaSessions` (`GET /app/account/sessions`) | 🗑️ **Removed from app — D-609 (2026-07-04)**, owner directive: screen backed up as `.bk`, More-menu "عروض الجلسات" row deleted, route → ComingSoon _(was: 🟢 Wave 2 my-sessions "عروض الجلسات", Figma `1388:9067`, D-588)_ | Approved | _(Figma 1388:9067)_ | [e2e/mobile-my-sessions.md](../tests/e2e/mobile-my-sessions.md) |
