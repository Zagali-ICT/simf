...
| #20 `speakerProfile` (`GET /app/speakers/{id}` + `…/meeting-requests`) | 🟢 Screen built (D-303); Figma 908-2110 parity — CV pill/card spacing (P3) | Guest+ (meeting: Visitor) | [App/Page_020](../App/Page_020/README.md) | [e2e/mobile-speaker-profile.md](../tests/e2e/mobile-speaker-profile.md) |
