...
| `sessionSummaryList` (`GET /app/programme/sessions`) — #1/#6 | 🟢 Screen built; home "ملخص الجلسات" tile → list of all sessions → #34 details; on-device render pending | Guest+ | _(reuses Page_016 list)_ | [e2e/mobile-ai-summary.md](../tests/e2e/mobile-ai-summary.md) |
