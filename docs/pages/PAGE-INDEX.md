...
| `identityVerification` (`POST /app/account/avatar`) — avatar liveness, additive | 🟢 Screen built (D-404) · **clean-code decompose + progress-bar bug fix (D-610)** — 489→304 + 3 files, 2 sub-widget goldens; **L4 Figma parity PENDING owner** (frames 758:4180/4248/4316 are full-bleed pose photos vs the built framed/prompt/progress design) | Visitor (approved) | — (Figma 758:4180/4248/4316) | [e2e/mobile-identity-verification.md](../tests/e2e/mobile-identity-verification.md) |
