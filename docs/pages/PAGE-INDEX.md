...
| #7 `signUpVisitor` — **profile data** (ProfileType + lookups; **Next → interests**) | 🟢 Screen built (D-368, KSA frame 168:2972) | Visitor | [App/Page_007](../App/Page_007/README.md) | [e2e/mobile-sign-up-visitor.md](../tests/e2e/mobile-sign-up-visitor.md) |
| #7‑01 `signUpInterests` — **interests (1–10) + the single `POST /app/account/user-profile` save** | 🟢 Screen built (D-365, KSA frame 505:1083) | Visitor | [App/Page_007-01](../App/Page_007-01/README.md) | [e2e/mobile-sign-up-interests.md](../tests/e2e/mobile-sign-up-interests.md) |
...
| #13 `home` (`GET …/notifications/unread-count`, signed-in only; `/app/bootstrap` is built but unused by the app) | 🟢 Screen built | Guest+ | [App/Page_013](../App/Page_013/README.md) | [e2e/mobile-home.md](../tests/e2e/mobile-home.md) |
...
| #18 `mySeat` (`GET /app/sessions/{id}/seats` + reserve/release) | 🟢 Screen built (D-301); Figma 898-2873 **full parity** (2026-06-19, device-verified) — square centred seats, transparent available, LTR legend محجوز·متاح·مقعدك, exact location icon | Visitor (login-only) | [App/Page_018](../App/Page_018/README.md) | [e2e/mobile-my-seat.md](../tests/e2e/mobile-my-seat.md) |
| `seatPicker` (`POST …/seats/reserve` / `reserve-random`) — D-485 | 🟢 Screen built (D-485); selectable hall grid → reserve a seat (Pending); on-device render pending | Visitor (login-only) | _(reuses Page_018 grid)_ | [e2e/mobile-seat-picker.md](../tests/e2e/mobile-seat-picker.md) |
| `joinSessionHub` (`GET /app/programme/sessions`) — D-485 | 🟢 Screen built (D-485); lists sessions → detail (the standalone join entry); on-device render pending | Visitor (login-only) | _(reuses Page_016 list)_ | [e2e/mobile-join-hub.md](../tests/e2e/mobile-join-hub.md) |
| #19 `speakers` (`GET /app/speakers`; avatar `GET /app/assets/SpeakerPhoto/{id}/image`) | 🟢 Screen built (D-302); speaker photo render — anchor fallback (P4) | Guest+ | [App/Page_019](../App/Page_019/README.md) | [e2e/mobile-speakers.md](../tests/e2e/mobile-speakers.md) |
| #20 `speakerProfile` (`GET /app/speakers/{id}` + `…/meeting-requests`; photo `GET /app/assets/SpeakerPhoto/{id}/image`) | 🟢 Screen built (D-303); Figma 908-2110 parity — CV spacing (P3) + photo avatar (P4) | Guest+ (meeting: Visitor) | [App/Page_020](../App/Page_020/README.md) | [e2e/mobile-speaker-profile.md](../tests/e2e/mobile-speaker-profile.md) |
| #22 `booths` (`GET /app/booths` + `/{id}`) | 🟢 Screen built (D-304; real CompanyLogo D-440); #9 — shows the booth **country** (flag + name, resolved from the Country lookup) + the أرشدني CTA deep-links the map | Guest+ | [App/Page_022](../App/Page_022/README.md) | [e2e/mobile-booths.md](../tests/e2e/mobile-booths.md) |
...
| #23 `sponsors` (`GET /app/sponsors`) | 🟢 Screen built (D-305; tiered grid + real SponsorLogo D-440); Wave 3 — tapping a sponsor opens the sponsor detail | Guest+ | [App/Page_023](../App/Page_023/README.md) | [e2e/mobile-sponsors.md](../tests/e2e/mobile-sponsors.md) |
| #220 `exhibitorDetail` (`GET /app/booths/{id}`) | 🟢 Wave 3 (Figma `1439:11881`); booth tap → full exhibitor detail (logo/name/city·country/tier pill/stand-code→map/about/website); booth detail DTO += Website/City/Tier (additive, migration D498) | Guest+ | _(Figma 1439:11881)_ | [e2e/mobile-exhibitor-detail.md](../tests/e2e/mobile-exhibitor-detail.md) |
| #221 `sponsorDetail` (`GET /app/sponsors/{id}`) | 🟢 Wave 3 (Figma `1439:11826`); sponsor tap → detail (shared template); new public detail endpoint + Sponsor `About`/Contact `City` (additive, migration D498) | Guest+ | _(Figma 1439:11826)_ | [e2e/mobile-sponsor-detail.md](../tests/e2e/mobile-sponsor-detail.md) |
| #21 `delegations` (`GET /app/delegations` — public, anonymous) | 🟢 Wave 4 (D-499, Figma `1426:10771`; screen #21 **restored** from D-277); invited-country delegations — stats strip + search + per-country card (flag/name/head + dates/member count); head from new `Country.HeadOfDelegationUserProfileId`, members derived from active delegate profiles; CP sets dates + head on `/admin/countries`; additive migration D499 | Guest+ (public) | [mobile/delegations.md](mobile/delegations.md) | [e2e/mobile-delegations.md](../tests/e2e/mobile-delegations.md) |
| #24 `archive` (`GET /app/archive` + `/{id}`) | 🟢 Screen built (D-307; real gallery/speaker photos D-440) | Guest+ | [App/Page_024](../App/Page_024/README.md) | [e2e/mobile-archive.md](../tests/e2e/mobile-archive.md) |
...
| #34 `aiSummary` (`GET /app/programme/sessions/{id}/summary`) | 🟢 Screen built (D-317); stacked-cards Figma `1078:14952` (D-465); #1/#6 — details-only (picker hidden) when opened with a sessionId | Guest+ | [App/Page_034](../App/Page_034/README.md) | [e2e/mobile-ai-summary.md](../tests/e2e/mobile-ai-summary.md) |
| #111 `sessionSummaryList` (cached programme + favourites/booked overlay) | 🟢 Wave 2 pixel pass to Figma `1388:8392`; searchable, day-grouped list with الجميع/جلساتي/المفضلة tabs + the المفضلة heart (`GET/POST/DELETE /app/sessions/favourites`); tap → #34 details; on-device render pending | Guest+ (favourites/booked Approved) | _(Figma 1388:8392)_ | [e2e/mobile-session-summaries.md](../tests/e2e/mobile-session-summaries.md) |
...
| #25 `liveBroadcast` (`GET /app/programme/sessions/{id}`) | 🟢 Screen built (D-321; YouTube provider D-349; AI captions D-439) | Guest+ | [App/Page_025](../App/Page_025/README.md) | [e2e/mobile-live.md](../tests/e2e/mobile-live.md) |
...
| `requests` (`GET /app/my-requests` + `POST …/document-requests` · `…/badge-requests` · `…/my-requests/cancel`) — Wave 5 (D-500, Figma `1408:9726`); the **الطلبات** unified feed — **supersedes** the D-479 read-only My-meetings screen | 🟢 Screen built (D-500) | Visitor (approved) | [mobile/requests.md](mobile/requests.md) | [e2e/mobile-requests.md](../tests/e2e/mobile-requests.md) |
| `sessionModerate` (`GET/PUT /app/sessions/{id}/questions/moderate·push·hide`) — moderator Q&A, additive (D-509: 5 chips + reject/answered/on-stage re-skin) | 🟢 Screen built (D-405/D-509) | Moderator+ (server: per-session grant) | — (Figma 1461:12227) | [e2e/mobile-session-moderate.md](../tests/e2e/mobile-session-moderate.md) |
| `gateScanner` (`GET /app/gates/my-assignments` · `POST /app/gates/{id}/scans`) — staff gate console (D-509: setup + operator دخول/خروج honoured for Both-mode gates), additive | 🟢 Screen built (D-406/D-509) | Staff (server: GateOperator grant) | — (Figma 758:4651/4819/4886) | [e2e/mobile-gate-scan.md](../tests/e2e/mobile-gate-scan.md) |
| `staffRegisterVisitor` (`POST /app/staff/visitors/register-onsite` · `…/{id}/id-document` · `…/{id}/avatar`) — staff walk-in visitor registration, additive (D-509) | 🟢 Screen built (D-509) | Staff (server: Visitors.RegisterOnsite) | — (Figma 1467:12357) | [e2e/mobile-staff-register-visitor.md](../tests/e2e/mobile-staff-register-visitor.md) |
...
| #201 `faq` (`GET /app/faq` — public, anonymous) | 🟢 Screen built from ComingSoon (D-464 stub → Figma `1388:7567`); accordion over the D-211 FAQ tables; new public read endpoint (no schema change); reached from المزيد → الأسئلة الشائعة | Guest+ | _(Figma 1388:7567)_ | [e2e/mobile-faq.md](../tests/e2e/mobile-faq.md) |
| #203 `contactUs` (`POST /app/contact-inquiry` + `GET /app/organization-profile`) | 🟡 App screen built from ComingSoon (D-464 stub → Figma `1388:7711`); form + org-profile info panel + social; new `ContactInquiries` table (additive, migration pending) + CP inbox `/admin/contact-inquiries` (perms `ContactInquiries.View`/`.Manage`, pending) | Guest+ (submit anonymous) | _(Figma 1388:7711)_ | [e2e/mobile-contact-us.md](../tests/e2e/mobile-contact-us.md) |
| #202 `sessionPresentations` (`GET /app/presentations` + `/{id}/file`) | 🟢 Screen built from ComingSoon (D-464 stub → Figma `1388:7621`); day-tabbed deck list over the D-228 `SpeakerPresentation` files; new public read + download endpoints (no schema); تحميل → OS share/save; reached from المزيد → عروض الجلسات | Approved | _(Figma 1388:7621)_ | [e2e/mobile-session-presentations.md](../tests/e2e/mobile-session-presentations.md) |
| #113 `myAreaSessions` (`GET /app/account/sessions`) | 🟢 Wave 2 my-sessions (Figma `1388:9067`); القادمة/حضرتها/فاتتني/الأرشيف tabs over the visitor's booked sessions + per-user attended/favourite flags (no schema); reached from the My-Area "my sessions" counter | Approved | _(Figma 1388:9067)_ | [e2e/mobile-my-sessions.md](../tests/e2e/mobile-my-sessions.md) |
