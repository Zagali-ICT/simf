...
| #36 `chatbot` (interim shell — no API) | ✅ Real — Figma `1064:13066`; **clean-code frozen (D-631)**. AI-assistant shell — scripted transcript + quick-reply chips + composer; overridable `chatbotResponderProvider` seam (default canned notice); no backend endpoint (interim) | Guest+ | [mobile/chatbot/](mobile/chatbot/README.md) | [e2e/mobile-chatbot.md](../tests/e2e/mobile-chatbot.md) |
