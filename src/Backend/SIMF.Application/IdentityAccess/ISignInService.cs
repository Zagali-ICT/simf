...
public interface ISignInService
{
    ...
    /// <summary>Re-issue + email the visitor sign-in OTP for an in-progress
    ...
    /// The MFA token is the same ticket the password step issued.
    /// </summary>
    ...
    /// <summary>
    /// Step one of MANDATORY enrolment. Exchanges the
    ...
    /// <summary>
    /// Step two of MANDATORY enrolment. Verifies the first authenticator
