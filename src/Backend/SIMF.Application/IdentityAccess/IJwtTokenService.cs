...
public interface IJwtTokenService
{
    ...
    /// <para><paramref name="permissions"/> are the resolved
    ...
    /// <para><paramref name="secondFactorCompleted"/> drives the
    ...
    /// against any other endpoint. It also carries the requesting
    ...
    /// <summary>The NCA-mandated absolute session lifetime
