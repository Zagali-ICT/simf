...
public sealed record AuditEntry
{
    ...
    /// <summary>Optional snapshot of the subject's display name
    ...
    /// the subject — for example, an admin resetting another user's 2FA.
    /// Null when actor and subject are the same person (the usual case).
    /// </summary>
    public Guid? ActorUserId { get; init; }

    /// <summary>Optional snapshot of the actor's display name.
