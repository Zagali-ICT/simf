...
/// submission + admin review. Was a sibling of the session-scoped flow
/// (<c>IMeetingRequestService</c>, since removed), kept separate so the two
...
public interface ISpeakerMeetingRequestService
{
    ...
    /// <summary>Re-mints the speaker's Approve/Reject confirmation tokens for a
    ...
    /// <summary>An operator checks the meeting in at the hall,
    ...
    /// <summary>Puts a Rejected / Cancelled request back to a clean
