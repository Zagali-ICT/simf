        ...
        try
        {
            ...
            foreach (var uid in recipients)
            {
                await notifications.DispatchAsync(new NotificationRequest
                {
                    ...
                    Body = $"Table meeting on {meeting.StartUtc.UtcDateTime:yyyy-MM-dd HH:mm} UTC.",
                    BodyArabic = $"اجتماع طاولة بتاريخ {meeting.StartUtc.UtcDateTime:yyyy-MM-dd HH:mm} بالتوقيت العالمي.",
                    Severity = severity,
