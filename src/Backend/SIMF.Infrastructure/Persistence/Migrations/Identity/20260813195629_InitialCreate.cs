        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastSuccessfulSignInAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SecondFactorTokens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SecondFactorTokens_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SecondFactorTokens_TokenHash",
                table: "SecondFactorTokens",
                column: "TokenHash",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SecondFactorTokens_UserId",
                table: "SecondFactorTokens",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_AccountState_StateChangedAt",
                table: "Users",
                columns: new[] { "AccountState", "StateChangedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Users_UserType_CreatedAt",
                table: "Users",
