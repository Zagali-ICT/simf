...
namespace SIMF.Infrastructure.Persistence.Migrations.Identity
{
    ...
    [Migration("20260529154526_AddProfileTypeMobileAppRole")]
    partial class AddProfileTypeMobileAppRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SIMF.Domain.IdentityAccess.Interest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SIMF.Domain.IdentityAccess.ProfileType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SIMF.Domain.IdentityAccess.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SIMF.Domain.IdentityAccess.UserProfile", b =>
                {
                    b.HasOne("SIMF.Domain.IdentityAccess.ProfileType", "ProfileType")
                        .WithMany()
            ...
            modelBuilder.Entity("UserProfileInterests", b =>
                {
                    b.HasOne("SIMF.Domain.IdentityAccess.Interest", null)
                        .WithMany()
                        .HasForeignKey("InterestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SIMF.Domain.IdentityAccess.UserProfile", null)
                        .WithMany()
