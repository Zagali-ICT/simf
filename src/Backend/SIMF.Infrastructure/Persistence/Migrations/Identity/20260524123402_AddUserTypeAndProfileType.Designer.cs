...
namespace SIMF.Infrastructure.Persistence.Migrations.Identity
{
    ...
    [Migration("20260524123402_AddUserTypeAndProfileType")]
    partial class AddUserTypeAndProfileType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SIMF.Domain.IdentityAccess.VisitorProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SIMF.Domain.IdentityAccess.SimfUser", b =>
                {
                    b.HasOne("SIMF.Domain.IdentityAccess.ProfileType", null)
                        .WithMany()
