...
namespace SIMF.Infrastructure.Persistence.Migrations.App
{
    ...
    [Migration("20260603170233_D269_AddSpeakerMeetingRequests")]
    partial class D269_AddSpeakerMeetingRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SIMF.Domain.Companies.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("IsActive", "Type", "NameAr");

                    b.ToTable("Companies", (string)null);
                });

            modelBuilder.Entity("SIMF.Domain.Companies.CompanyMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SIMF.Domain.Delegations.Delegation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("IsActive", "IsPriority", "DisplayOrder");
            ...
            modelBuilder.Entity("SIMF.Domain.Exhibition.Booth", b =>
                {
                    ...
                    b.Property<string>("ExhibitorNameAr")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("ExhibitorNameEn")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
            ...
            modelBuilder.Entity("SIMF.Domain.Media.MediaItem", b =>
                {
                    ...
                    b.Property<string>("AlbumAr")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("AlbumEn")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.HasIndex("IsActive", "AlbumEn", "DisplayOrder");

                    b.ToTable("MediaItems", (string)null);
                });

            modelBuilder.Entity("SIMF.Domain.MeetingRequests.MeetingRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SIMF.Domain.MeetingRequests.SpeakerMeetingRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SIMF.Domain.Profiles.Interest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SIMF.Domain.Profiles.ProfileType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SIMF.Domain.AccessControl.GateProfileTypeAllow", b =>
                {
                    ...
                    b.HasOne("SIMF.Domain.Profiles.ProfileType", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SIMF.Domain.BusinessMeetings.BusinessMeetingParticipant", b =>
                {
                    ...
                    b.HasOne("SIMF.Domain.Companies.Company", "Company")
                        .WithMany()
            ...
            modelBuilder.Entity("SIMF.Domain.Exhibition.Booth", b =>
                {
                    b.HasOne("SIMF.Domain.Companies.Company", null)
                        .WithMany()
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("SIMF.Domain.Profiles.UserProfile", b =>
                {
                    ...
                    b.HasOne("SIMF.Domain.Profiles.ProfileType", "ProfileType")
                        .WithMany()
                        .HasForeignKey("ProfileTypeId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("UserProfileInterests", b =>
                {
                    b.HasOne("SIMF.Domain.Profiles.Interest", null)
                        .WithMany()
