...
/// supported nationality picker list (renamed from
/// <c>/account/visitor-profile/countries</c>). Auth required; the data
...
///
/// <para>Reads the live <see cref="SIMF.Domain.Common.Country"/>
