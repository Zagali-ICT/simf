...
/// </summary>
public sealed class ListAdminsEndpoint(IAdminUserProvisioningService adminAccountService)
...
/// </summary>
public sealed class ListOthersEndpoint(IAdminUserProvisioningService adminAccountService)
    : Endpoint<GridQuery, ApiResult<GridPage<AdminUserSummary>>>
{
    public override void Configure()
    {
...
/// </summary>
public sealed class ListVisitorsEndpoint(IAdminUserProvisioningService adminAccountService)
    : Endpoint<GridQuery, ApiResult<GridPage<AdminUserSummary>>>
{
    public override void Configure()
    {
