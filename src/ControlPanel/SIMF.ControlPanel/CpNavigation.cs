...
/// The former 23-item "System" group was split into coherent groups (People
/// absorbed the attendee accounts; new Scientific committee / Public relations /
/// Gates &amp; arrivals / Reference data groups). Each label is a resource key
/// resolved through <see cref="Strings" />. Each item carries a
...
public static class CpNavigation
{
    ...
    /// and which are not. <c>RequiredPermission</c> is the permission code that gates
    /// the item in the side menu; <c>null</c> means always visible to any
    ...
    [
        ...
        [
            ...
            // Visitor + Other attendee accounts and their pending
            ...
            // Dedicated VVIP/VIP registration + the موج welcome-data export.
        ...
        // Access control grouped together: the admin accounts that
        ...
        [
            ...
            // The CP surface for seat reservations: hall seat
            ...
            // There is deliberately NO separate page for the per-hall arrival
            // boundary:
            ...
            // The team defines a hall's meeting time (availability windows).
            // Hall-scoped code (both meeting desks read the slots it produces).
            ...
            // The team defines a delegation/country's availability windows.
            ...
            // The الطلبات desks: participation-document + badge-update request review.
            ...
            // Admin-arranged B2B/B2C business meetings.
        ...
        [
            ...
            // The moderator's own live-queue desk is
        ...
        [
            ...
            // exhibitor + account provisioning) plus Booths and Sponsors;
        ...
        new("Nav.System",
        [
            // System Configuration. Collapses the
