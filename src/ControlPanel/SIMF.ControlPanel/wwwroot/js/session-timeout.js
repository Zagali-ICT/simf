...
//
// start(config) is called from the signed-in shell (SessionTimeoutGuard.razor);
// stop() runs on dispose. All UI text + thresholds come from config so the same
// module serves the Control Panel and the Website, in English and Arabic (RTL).
