...
// Website — reset password. Takes the emailed 6-digit code and a new password;
// on success the card swaps to a confirmation. Markup lives in ResetPassword.razor.
