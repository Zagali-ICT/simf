...
public class PlatformViewVideoPlayer extends VideoPlayer {
  ...
  public static PlatformViewVideoPlayer create(
    ...
    return new PlatformViewVideoPlayer(
        ...
        options,
        () -> {
          // SIMF D-768 patch: faulty Huawei/HiSilicon AVC decoders fail to init
          // even though format_supported=YES. setEnableDecoderFallback(true) falls
          // back to the Android software AVC decoder; also force SYNCHRONOUS
