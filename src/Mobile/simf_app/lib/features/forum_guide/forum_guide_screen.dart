...
/// Forum guide — دليل الملتقى · route: `RouteNames.forumGuide`
/// Figma 1388:7493
/// Contract: static in-app copy, no backend (the steps live in [AppL10n]); the
/// caret on each card is decorative — the steps do not navigate.
