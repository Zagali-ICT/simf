...
/// LEGACY — the pre-redesign mockup Page 003 sign-in, parked here when the
/// KSA-Project design was promoted to the official `/sign-in` (D-360, app
/// redesign programme). Never routed; kept compiling until the owner approves
/// deleting the legacy directory at programme close (§6 freeze rules).
///
