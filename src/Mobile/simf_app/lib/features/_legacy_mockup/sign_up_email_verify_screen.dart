...
/// LEGACY — the pre-redesign Page 006 email verification, parked here when
/// the KSA-Project OTP design landed at the real path (D-364). Never routed;
/// kept compiling until programme close (§6 freeze rules).
///
