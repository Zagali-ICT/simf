...
/// [boothId]) shown **whole** inside the tile, falling back to the booth
/// **short name** (centred, as the frame shows "SAMI") while it loads or when
/// the booth has no logo.
///
/// Owner 2026-07-26 — the mark now FITS its tile (the old `BoxFit.cover`
/// cropped wide company logos), via the shared [SimfLogoImage].
/// Full-size-on-tap is OFF here on purpose: the tile sits inside the tappable
/// booth card, whose tap owns the navigation to the exhibitor detail — where
/// the 108px identity logo IS tappable to full size.
///
