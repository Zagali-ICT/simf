...
/// الرئيسية" — the [code] (gold) + a beige dot + the [name] (beige); otherwise
/// it falls back to a single gold [name] label.
class BoothHallBox extends StatelessWidget {
  ...
  /// The gold hall code (the frame's upper-cased English hall name), or null
  /// for the single-tone fallback.
  final String? code;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: code == null
          ...
          // Frame 922:2624 — pinned LTR so the gold "HALL A" leads and the
          // beige Arabic name trails, matching the frame regardless of the
          // app's RTL.
          : Row(
