/// App API routes owned by the news feature.
///
...
abstract final class NewsEndpoints {
  static const String list = '/app/news';
  static String article(String id) => '/app/news/$id';
}
