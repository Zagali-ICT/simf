...
class _ShareMyContactScreenState extends ConsumerState<ShareMyContactScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      // camera can add the contact, AND the in-app scanner can extract the
      // token to resolve + save the live card. Only the QR's content changed;
      // the rest of the screen (share .vcf, rotate) is unchanged.
      final vcard =
