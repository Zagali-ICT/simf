...
/// summary — same signal the summaries list filters on. When the programme
/// isn't loaded yet ([session] null) it falls back to the presentation's own
/// start: a not-yet-started session can't have a summary, so its button stays
/// inactive; a started/past one keeps it (a real 404 shows the summary screen's
/// empty note).
