...
/// (D-358). Same behaviour contract as Page 003: email + password against
/// `POST /app/auth/sign-in`, the 2FA email-OTP redirect, the post-sign-in
/// profile-completeness route, and the device-key biometric path. The email is
/// pre-filled from the last successful sign-in; the design's "remember me"
/// checkbox gates whether the email is stored for the next prefill.
...
class _Login2ScreenState extends ConsumerState<Login2Screen> {
  ...
  /// profile-completion screen (Page_007); everyone else goes home — the same
  /// contract as Page 003 (D-288 Slice 3).
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: ConstrainedBox(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          _Header(title: l10n.login2ForumTitle),
