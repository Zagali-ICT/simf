/// Wire models for the Live broadcast screen (Page_025).
///
/// Split out of `live_repository.dart`: a repository is the transport, and
/// keeping the DTOs beside it meant the file grew to 254 lines carrying two
/// unrelated jobs. The JSON keys are the shipped wire contract (D-219) and
