/// App API routes owned by the chatbot feature.
///
...
abstract final class ChatbotEndpoints {
  static const String assistance = '/app/ai/assistance';
  static const String history = '/app/ai/assistance/history';
}
