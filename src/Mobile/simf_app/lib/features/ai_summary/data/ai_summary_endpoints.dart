/// App API routes owned by the ai_summary feature.
///
...
abstract final class AiSummaryEndpoints {
  static String sessionSummary(String sessionId) => '/app/programme/sessions/$sessionId/summary';
}
