/// App API routes owned by the questions feature.
///
...
abstract final class QuestionsEndpoints {
  static String forSession(String sessionId) => '/app/sessions/$sessionId/questions';
}
