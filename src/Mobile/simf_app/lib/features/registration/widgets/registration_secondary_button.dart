...
import 'package:simf_app/features/registration/widgets/registration_primary_button.dart' show RegistrationPrimaryButton;
import 'package:simf_app/features/registration/widgets/registration_sign_out_link.dart' show RegistrationSignOutLink;
...
class RegistrationSecondaryButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: SimfTokens.registrationSecondaryButtonHeight,
