...
/// <summary>Registers a new biometric
...
public sealed class RegisterDeviceKeyRequest
{
    ...
    /// <summary>The emailed-OTP step-up code confirming the user intends
...
/// <summary>The result of requesting a biometric-enrol step-up code: the
