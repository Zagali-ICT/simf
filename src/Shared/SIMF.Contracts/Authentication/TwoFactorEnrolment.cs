...
/// <summary>
/// The body of <c>POST /api/v1/app/auth/totp/enrolment/complete</c>.
...
/// <summary>
/// The result of a completed mandatory enrolment: the account is now
...
/// shown plaintext exactly once. The API never returns them again.</param>
