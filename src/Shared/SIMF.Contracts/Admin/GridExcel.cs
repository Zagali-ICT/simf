...
/// <summary>
/// Request body for a generic grid Excel export (D-356). Mirrors the per-user
...
/// <summary>
/// Per-row outcome summary of a generic grid Excel import (D-356). Mirrors the
...
/// <summary>One failed row in a generic grid import (D-356). <see cref="Key"/>
