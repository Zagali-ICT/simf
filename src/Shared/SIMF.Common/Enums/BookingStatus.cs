...
/// <summary>P2.2 — D-227 (SIMF-FDS-005 §4): the lifecycle state of a seat
...
/// <item><see cref="Pending"/> — NO production writer (A9, 2026-07-27). It is the
...
/// persists it.</item>
/// <item><see cref="Rejected"/> — NO production writer (A9). There is no reject
...
/// frozen against renumbering (D-110), <c>Rejected = 2</c> is decoded by the
...
/// D-175 uniqueness indexes; <see cref="Cancelled"/> sets <c>ReleasedAt</c>, freeing
