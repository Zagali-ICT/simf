// D-194 — closes the "Tests: SIMF.Web.Tests (todo)" marker on
// SIMF.Web.SignInTicketStore. Mirrors SIMF.ControlPanel.Tests'
// SignInTicketStoreTests; the two stores are duplicated by design
// (the cookie-write hand-off split between the two host projects).
