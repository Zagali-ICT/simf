...
/// <summary>
/// Integration tests for the D-356 session-summaries grid export. The محضر desk
...
public sealed class SessionSummariesExcelTests : IClassFixture<SimfApiFactory>
{
    ...
    public SessionSummariesExcelTests(SimfApiFactory factory)
    {
        _factory = factory;
    ...
    public async Task Export_returns_an_xlsx_workbook()
    {
        ...
        var response = await PostAuthAsync(
            "/api/v1/admin/session-summaries/export",
    ...
    {
        var email = $"summary-xlsx-admin-{Guid.NewGuid():N}@simf.test";
        using (var scope = _factory.Services.CreateScope())
        {
            ...
            var user = new SimfUser
            {
                ...
                Email = email,
                EmailConfirmed = true,
                DisplayName = "Test Summary Excel Admin",
