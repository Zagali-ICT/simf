        ...
        "blocks": [
            ...
            bullets(
                ["The year must be four digits between 2000 and 2999. A typed "
                 ...
                 "their badge dead."],
                ["يجب أن تكون السنة من أربعة أرقام بين ٢٠٠٠ و٢٩٩٩. ويُرفض ما "
                 "يُكتب مثل «٢٠٢» أو «٢٠٢٦٥»، لأن السنة تُطبع في الشارة ويقرؤها "
            ...
            table(
                ...
                [
                    ["يجيب عن", "من فعل ماذا، بمن، وهل نجح",
                     "ما الذي فعله البرنامج تقنيًّا عند الساعة ١٤:٣٢"],
            ...
            note("The operation log stores the subject's name as it was at the "
                 ...
                 "يحفظ سجل العمليات اسم المعنيّ كما كان حينها، فيظل المدخل مقروءًا "
                 "بعد إعادة تسميته. ولا يحمل سطر تفصيله سرًّا أبدًا."),
            ...
            table(
                ...
                [
                    ...
                    ["مسح الاحتفاظ", "التنقية اليومية للأدلة الأمنية منتهية "
                     "الصلاحية"],
                ]),
            ...
            bullets(
                ...
                ["لا تحمل قاعدة البيانات إلا تغييراتك. فالقالب الذي لم تمسسه "
                 ...
                 "صحيحة والجدول فارغ.",
                 "والرموز البديلة خاصة بكل قالب وتُعرض شارات إلى جانب المحرّر — "
