            ...
            table(
                ...
                [
                    ["FDS-006: sponsor tiers are Strategic, Premium and Gold",
                     "They are Platinum, Gold, Silver and Bronze, and a new "
                     "sponsor starts at Bronze. Exhibitors carry a separate tier "
                     "list of their own"],
                    ...
                    ["FDS-012: registration is opened and closed from the System "
                     ...
                     "ships empty and holds no registration control"],
                ],
                [
                    ["FDS-006: فئات الرعاة استراتيجي وبريميوم وذهبي",
                     "هي بلاتيني وذهبي وفضي وبرونزي، ويبدأ الراعي الجديد عند "
                     "البرونزي. وللعارضين قائمة فئات منفصلة خاصة بهم"],
                    ...
                    ["FDS-012: يُفتح التسجيل ويُغلق من صفحة تهيئة النظام",
                     "بل من صفحة العمليات. وجدول التهيئة يُشحن فارغًا ولا يحمل أي "
                     "تحكم في التسجيل"],
                ]),
