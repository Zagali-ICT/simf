    ...
    return {
        ...
        "blocks": [
            ...
            note("Two rules catch people out. A session code stays reserved after "
                 ...
                 "قاعدتان توقعان الناس في الخطأ. يظل رمز الجلسة محجوزًا بعد حذفها، "
                 "لأن الحذف تعطيل لا إزالة — فيُرفض إعادة استخدام رمز جلسة ملغاة. "
                 "ولا يمكن أن تتداخل جلستان نشطتان في القاعة نفسها؛ وتُرفض الثانية "
                 "رفضًا صريحًا لا تُعلَّم فحسب."),
            ...
            bullets([
                ...
                "واحد لأحد كبار الشخصيات أو تحرير محجوز.",
            ...
            note("The state that causes the most confusion is the one between "
                 ...
                 "الآخر، حين تكون قد أخذت موافقة المتحدث سلفًا: "
