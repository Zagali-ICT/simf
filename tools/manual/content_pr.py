    ...
    return {
        ...
        "blocks": [
            ...
            table(
                ...
                [
                    ...
                    ["كبار الشخصيات — إشعار", "ملفات كبار الشخصيات التي تحدّدها",
                     "٥٠٠ في الإرسالة الواحدة، ويُرفض ما زاد",
            ...
            p("Submitting does not send. It writes one pending job and hands back "
              ...
              "ويتولى الإرسال. ويترتب على ذلك أمران، وكلاهما يفاجئ الناس."),
            bullets(
                ...
                ["**الرقم الذي عُرض عليك تقدير حُسب لحظة الإرسال.** فالمستلمون "
                 ...
                 "وذلك تحديدًا حتى لا يؤدي إعادة التشغيل في منتصف الإرسال إلى "
