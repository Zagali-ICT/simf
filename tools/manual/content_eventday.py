    ...
    return {
        ...
        "blocks": [
            ...
            table(
                ...
                [
                    ...
                    ["باب قاعة، وهو غير مسجّل في أي جلسة تسمح بها",
                     "يحتاج إلى حجز، أو إلى فتح وضع الحضور المباشر لذلك اليوم"],
                ]),
            ...
            p("Hall attendance is a different record from a gate scan. A scan is "
              ...
              "بالملف لا بالحساب، لأن الحاضر المباشر قد لا يملك حسابًا أصلًا."),
            bullets([
                ...
                "ولوحة البوابات تعرض من هم داخل الموقع حاليًا، مستنتجةً ذلك من آخر "
                "مسح مسموح لكل زائر.",
            ]),
            ...
            bullets([
                ...
                "وفي التهيئة المشحونة يكون المرشِّح صوريًّا حتى يُفعَّل.",
